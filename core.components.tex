...
\subsubsection{Multipleksors}
	...
	multipleksors tiek izmantots datu kopnē noslēdzot sazarojumu,
...
\subsubsection{Aritmētiski loģiskā ierīce} \label{sec:alu}
	...
	loģikas darbības, atstājot bīdes operācijas „Bitu bīdes loģiskai ierīcei”
	...
	kurš ir bāzēts uz D.~Perija parauga \cite[307.~lpp.]{Perry-VHDL}.
...
\subsubsection{Bitu bīdes loģiskā ierīce} \label{sec:shifter}
	...
	VHDL kods ir gandrīz identisks D.~Perija paraugam
	\cite[324.~lpp.]{Perry-VHDL}. Izmainīta ir \verb+t_shift+ tipa
	definīcija (sk.~\ref{kb:cpulib}~pirmkodu) uz \verb+std_logic_vector+
	tipu, lai |sel| signālu	varētu nodot tieši no operācijas koda.
...
\subsubsection{Komparators} \label{sec:comp}
	...
	kontroles signālus (salīdzinājumam ar D.~Perija realizāciju sk.~\ref{sec:perry-comp}~nod.).
	...
	informāciju ir pilnīgi pietiekami, lai būtu iespējams realizēt visas
	nosacījuma zarošanās (\mnem{BRxx}) instrukcijas
	(sk.~\ref{sec:branching}~nod.).
	\begin{figure}[bhp]
		\centering
		%\def\svgwidth{7cm}
		\def\svgscale{1.25}
