...
void fast9_score(const SubImage<byte>& i, const vector<ImageRef>& corners, int b, vector<int>& scores)
{
...
void fast9_detect(const SubImage<byte>& i, vector<ImageRef>& corners, int b)
{
	corners.clear();
