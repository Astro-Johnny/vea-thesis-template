\subsection{VHDL} \label{sec:vhdl}
	...
	projekta ietvaros \cite[1.~lpp.]{Perry-VHDL}\cite[141.~lpp.]{VHSIC}.
...
% PIEZĪME: Rekomendēju tabulām izmantot \usepackage{booktabs} bet tā kā
%          tā maina \begin{tabular} darbību un nāk ar savām stila izvēlēm,
%          šablonā paliek kā autora izvēle.
% sk: https://en.wikibooks.org/wiki/LaTeX/Tables#Professional_tables
% sk: http://mirrors.ctan.org/macros/latex/contrib/booktabs/booktabs.pdf
	\begin{table}[thb]\small
		...
		\begin{tabular}{p{0.2\textwidth}p{0.36\textwidth}p{0.36\textwidth}}
			% Ar \usepackage{booktabs} \hline -> \toprule, \midrule, \bottomrule
			\hline
			%\toprule
