...
\begin{tabularx}{\textwidth}{lX}
	...
	\textbf{Darba autors:} & Pēteris Lielais\\[1ex]              %% <---- Autors šeit
	\textbf{Darba vadītājs:} & Mg.~sc.~ing.~Jānis Šmēdiņš\\[1ex] %% <---- Vadītājs šeit
...
\begin{english} % The English abstract
	...
	\begin{tabularx}{\textwidth}{lX}
		...
		\textbf{Author:} & Pēteris Lielais\\[1ex]                %% <---- Autors šeit
		\textbf{Supervisor:} & Mg.~sc.~ing.~Jānis Šmēdiņš\\[1ex] %% <---- Vadītājs šeit
