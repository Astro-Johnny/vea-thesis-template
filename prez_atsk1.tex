		...
		\begin{columns}
			\column{0.6\textwidth}
				{\def\svgwidth{\textwidth}
				 \input{img/Scotland-in-UK.pdf_tex}}
			\column{0.38\textwidth}
				\begin{itemize}\small
					\item Scotland is a part of United Kingdom
					\item \textbf{Edinburgh} is the capital of Scotland
					\item Size: 78387 km$^2$ \\
						(1.2 $\times$
						\includegraphics[width=1.5em]{Latvia-flagmap})
					\item Population: 5.2~million
					\item \textit{Alba} is Scotland in Scottish Gaelic 
					\item The flag is\\
